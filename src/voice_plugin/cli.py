"""CLI entry point for amplifier-voice.

Boots a real amplifierd instance with the voice plugin. This is the
...
Usage::
    ...
    amplifier-voice
    amplifier-voice --port 9000
    amplifier-voice --reload
"""
...
def main(
    host: str | None, port: int | None, reload: bool, log_level: str | None
) -> None:
    """amplifier-voice — Amplifier Voice standalone app."""
    import os
    ...
    click.echo(
        f"amplifier-voice starting — http://{effective_host}:{effective_port}/voice/"
    )
